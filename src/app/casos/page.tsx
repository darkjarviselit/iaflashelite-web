            ...
            <main className="pt-32 pb-24 bg-onyx min-h-screen">
                ...
                <section className="relative pb-20">
                    <div className="max-w-3xl mx-auto px-6 lg:px-8">
                        <div className="p-10 sm:p-14 rounded-3xl border border-border-dark bg-surface flex flex-col items-start gap-6">
                            <h2 className="text-2xl sm:text-3xl font-semibold tracking-[-0.02em] leading-tight text-paper">
