...
export async function GET(
	...
	// Fuente pública (GitHub Releases, p. ej. Kenvo): el token ya validó la
	// compra, así que redirigimos al binario público. El gating sigue en el
	// token firmado (solo se genera tras pago verificado).
	if (secureProduct.releaseUrl) {
		return NextResponse.redirect(secureProduct.releaseUrl, 302);
	}
